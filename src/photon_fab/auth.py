...
PERMISSIONS = {
    "operator": {"read", "measure", "rework"},
    "engineer": {"read", "measure", "analyze", "submit", "rework"},
    "quality": {"read", "measure", "analyze", "approve", "release", "rework"},
    "admin": {"read", "measure", "analyze", "submit", "approve", "release", "rework", "admin"},
}
